      ...
      <div className="mx-auto px-4 sm:px-6 ">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              <div className="flex flex-col cursor-pointer ">
                ...
                <div className="ml-5">
                  <p className="text-xl font-bold leading-tight -mt-3 text-muted-foreground">
                    Arogya Sahayak
                  </p>
                </div>
              </div>
              ...
              <div className="my-9">
                <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                  ...
                  <li className="ml-4">
                    ...
                    >
                      <BiLogoInstagram className=" h-8 w-8 fill-current py-1  " />
        ...
        <div className="flex items-center justify-center py-2 -my-4 md:py-8 border-t border-gray-300">
          <div className="text-sm text-center text-gray-600 mr-4">
            Thanks for visiting this website 😊. Sending love from our Arogya
            Sahayak
          </div>
        </div>
      </div>
